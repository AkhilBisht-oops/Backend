...
const loginUser = asyncHandler(async (req, res) => {
    ...
    // - apply check if the username == username || email == email && password == password . Then perform some action.
...
const refreshAccessToken = asyncHandler(async (req, res) => {
    ...
    try {
        ...
        return res.status(200).cookie("accessToken", accessToken).cookie("refreshToken", newRefreshToken).jon(
